...
public class FlexboxTest {
	...
	public void setUp() throws IOException {
		...
		String URL =  "\\src\\test\\resources\\Flexbox\\layouttest.html";
	...
	public void homePageLayoutTest() throws IOException {
		...
		String gspecLocation = ".\\src\\test\\resources\\Flexbox\\layouttest.gspec";
		...
		GalenTestInfo test = GalenTestInfo.fromString("Flexbox-Test Ergebnisse");

		// // Holt den Layoutreport und ordnet es einem Test Objekt zu
		test.getReport().layout(layoutReport, "Check Flexbox-layout");
		...
		htmlReportBuilder.build(tests, ".\\src\\test\\resources\\Flexbox\\ErgebnisseDesFlexLayouts");
	...
	public void openFile(boolean oeffnen) throws IOException {
		if (oeffnen) {
			File datei = new File(
					".\\src\\test\\resources\\Flexbox\\ErgebnisseDesFlexLayouts\\report.html");
