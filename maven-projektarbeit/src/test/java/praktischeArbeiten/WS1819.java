...
public class WS1819 {
	...
	public void setUp() throws IOException {
		...
		String pathPage = "\\src\\test\\resources\\WS1819\\ws1819.html";
	...
	public void homePageLayoutTest() throws IOException {
		...
		String gspecLocation = ".\\src\\test\\resources\\WS1819\\ws1819.gspec";
		...
		GalenTestInfo test = GalenTestInfo.fromString("Ergebnisse WS1819 Layout");
		...
		htmlReportBuilder.build(tests, ".\\src\\test\\resources\\WS1819\\ErgebnisseWS1819");
	...
	/*
	 * Methode, um die report.html-Datei zu öffnen
	 */
 	public void openFile(boolean oeffnen) throws IOException {
		if (oeffnen) {
			File datei = new File(
					".\\src\\test\\resources\\WS1819\\ErgebnisseWS1819\\report.html");
